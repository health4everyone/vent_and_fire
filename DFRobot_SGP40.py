...
class DFRobot_SGP40:
    ...
    def __init__(self,relative_humidity = 50,temperature_c = 25):
        """ Module init
        ...
        """
        self.__i2cbus = I2C(0, mode=I2C.MASTER, pins=('P22', 'P21'))
#        self.__i2cbus = smbus.SMBus(bus)
    ...
    def measure_raw(self):
        ...
        self.__i2cbus.writeto(self.__i2c_addr, bytes([self.CMD_MEASURE_RAW_H, self.CMD_MEASURE_RAW_L,self.__rh_h,self.__rh_l,self.__rh__crc,self.__temc_h,self.__temc_l,self.__temc__crc]))
    ...
    def __measure_test(self):
        ...
        :return int self-test condition
          ...
          : 1 failed
        """
        self.__i2cbus.writeto(self.__i2c_addr,bytes([self.CMD_MEASURE_TEST_H, self.CMD_MEASURE_TEST_L]))
    ...
    def __reset(self):
        ...
        """
        self.__i2cbus.writeto(self.__i2c_addr,bytes([self.CMD_SOFT__reset_H, self.CMD_SOFT__reset_L]))
    ...
    def __heater_off(self):
        ...
        """
        self.__i2cbus.writeto(self.__i2c_addr,bytes([self.CMD_HEATER_OFF_H,self.CMD_HEATER_OFF_L]))
